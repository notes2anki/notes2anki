...
input_file_path = 'Computer Science_processed.csv'
  ...
  for i in range(1):
    ...
    completion = client.chat.completions.create(
      ...
      messages=[
        ...
        {"role": "user", "content": f"Given the following sets of flashcards {dataset}, create the {writtenOrNah} textbook notes as if the flashcards were created from them. I will pay you $50 for the textbook content that you generate for every set so be sure to state your responses separately as a numbered list."}
      ]
    )
    ...
    writer.writerow([message, dataset])
